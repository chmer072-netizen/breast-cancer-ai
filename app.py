...
# =========================
st.markdown(
    "<h1 style='text-align: center; color: #ff4da6;'>🎗️ Breast Cancer AI Assistant 🤖</h1>",
...
if uploaded_file is not None:
    ...
    if result == "Cancer Detected":
        ...
        st.error(
            f"⚠️ Cancer Detected — Confidence: {confidence}%"
        )
        ...
        st.success(
            f"✅ Normal Tissue — Confidence: {confidence}%"
        )
...
if user_question:
    ...
    if not found:
        ...
        st.warning(
            "Sorry, I do not have an answer for this question yet."
        )
